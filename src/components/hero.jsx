...
const hero = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className='w-full h-auto lg:max-h-[650px] flex flex-col lg:flex-row justify-evenly items-center py-12 gap-8'>
        {/* Left Content */}
        <div className='flex flex-col items-start gap-6  pt-6 px-12 max-w-4xl'>
          {/* Animated Heading */}
          <h1 className='font-extrabold text-5xl text-gray-300 leading-tight animate-slideIn'>
            Building Digital <br />
